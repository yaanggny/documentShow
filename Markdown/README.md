# Markdown syntax
介绍Markdown常用语法。   
Forked from [走进Markdown园子](https://github.com/Javef/Markdown)
...
代码
```markdown
查看详细内容请参考<a href="#ref1" id="c1">[19]</a>
......这里是其他内容。
### Ref
<a href="#ref1" id="c1">[1]</a> A and B. xxxxxx. In Proc. of IJCAI, 1981.
<a href="#ref3" id="c1">[3]</a> A and B. yyyyyy. In Proc. of IJCAI, 1981.

```
渲染
>查看详细内容请参考<a href="#ref1" id="c1">[1]</a><a href="#ref3" id="c2">[3]</a>
......这里是其他内容。
>### Ref
><a id="ref1">[1]</a> A and B. xxxxxx. In Proc. of IJCAI, 1981.
<a id="ref3">[3]</a> A and B. yyyyyy. In Proc. of IJCAI, 1981.
...
**书写格式如下：**
```markdown
使用 Markdown[^1]可以高效地书写文档, 可以使用 Leanote[^Le] 编辑器进行书写.
...
>使用 Markdown[^1]可以高效地书写文档,可以使用 Leanote[^Le] 编辑器进行书写.
>**注：** 在文档末尾可以看到脚注内容：
>![文档末尾的脚注](./res/Markdown_jiaozhu.jpg)
>[^1]: Markdown是一种纯文本标记语言  
>[^Le]: 开源笔记平台，支持Markdown和笔记直接发为博文  
